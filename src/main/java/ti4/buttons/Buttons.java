...
public class Buttons {
    ...
    // Cards Info Buttons
    public static final Button REFRESH_INFO = green("refreshInfoButton", "Other Info");
    public static final Button REFRESH_AC_INFO = green("refreshACButton", "Action Card Info");
    public static final Button REFRESH_PN_INFO = green("refreshPNButton", "Promissory Notes Info");
    public static final Button REFRESH_SO_INFO = green("refreshSOButton", "Secret Objectives Info");
