...
public class UploadStatsCron {
    ...
    public static void register() {
        CronManager.schedulePeriodicallyAtTime(UploadStatsCron.class, UploadStatsCron::uploadStats, 12, 45, ZoneId.of("UTC")); // ParsleySage is currently pulling at 14:00 UTC
    }
