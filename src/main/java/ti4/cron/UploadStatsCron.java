...
public class UploadStatsCron {
    ...
    public static void register() {
        CronManager.schedulePeriodicallyAtTime(UploadStatsCron.class, UploadStatsCron::uploadStats, 14, 30, ZoneId.of("UTC")); // ParsleySage is currently pulling at 14:00 UTC
    }
