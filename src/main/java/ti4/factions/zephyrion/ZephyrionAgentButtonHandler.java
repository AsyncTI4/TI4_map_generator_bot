package ti4.factions.zephyrion;
...
public class ZephyrionAgentButtonHandler {
    ...
    public static List<Button> getAgentButtons(Game game, Player player) {
        ...
        for (Player otherPlayer : game.getRealPlayersExcludingThis(player)) {
            for (String bounty : bounties) {
                ...
                if ("flagship".equalsIgnoreCase(ship) || "warsun".equalsIgnoreCase(ship)) continue;
