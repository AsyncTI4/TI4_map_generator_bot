...
public class ListSpends extends StatusSubcommandData {
    public ListSpends() {
        super(Constants.SPENDS, "List value of plastic and command tokens gained by players this game");
    }
    ...
    private String playerSpends(Player player) {
        return "> " + player.getUserName() + ": " + player.getTotalExpenses() + " total I/R value of plastic built and command tokens gained.";
    }
