...
public class RelicSendFragments extends RelicSubcommandData {
	...
	public RelicSendFragments() {
		...
		addOptions(
			...
			new OptionData(OptionType.STRING, Constants.FACTION_COLOR, "Source faction or color (default is you)").setAutoComplete(true),
	...
	public void execute(SlashCommandInteractionEvent event) {
		...
		Player receiver = CommandCommandHelper.getOtherPlayerFromEvent(game, event);
		if (receiver == null) {
