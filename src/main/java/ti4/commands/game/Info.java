...
public class Info extends GameSubcommandData{
    ...
    public static StringBuilder getGameInfo(OptionMapping gameOption, MapManager mapManager, Map activeMap, SlashCommandInteractionEvent event) {
        ...
        sb.append("Strategy Card Set: ").append(activeMap.getScSetID()).append(NEW_LINE);
        sb.append("Decks: ").append(NEW_LINE);
        sb.append("> Action Card Deck: ").append(activeMap.getAcDeckID()).append(NEW_LINE);
        sb.append("> Secret Objective Deck: ").append(activeMap.getSoDeckID()).append(NEW_LINE);
        sb.append("> Stage 1 Public Objective Deck: ").append(activeMap.getStage1PublicDeckID()).append(NEW_LINE);
        sb.append("> Stage 2 Public Objective Deck: ").append(activeMap.getStage2PublicDeckID()).append(NEW_LINE);
        sb.append("> Relic Deck:").append(activeMap.getRelicDeckID()).append(NEW_LINE);
        sb.append("> Agenda Deck:").append(activeMap.getAgendaDeckID()).append(NEW_LINE);
        sb.append("> Exploration Deck:").append(activeMap.getExplorationDeckID()).append(NEW_LINE);
