...
public class RevealAgenda extends AgendaSubcommandData {
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        String text = "Please response with your faction symbol in response to the next two posts - respond to <:nowhens:962921609671364658> or no whens and respond to <:noafters:962923748938362931> for no afters.";
