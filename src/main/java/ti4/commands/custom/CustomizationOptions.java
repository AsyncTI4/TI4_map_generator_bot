...
class CustomizationOptions extends GameStateSubcommand {
    ...
    public CustomizationOptions() {
        ...
        addOptions(new OptionData(
                OptionType.BOOLEAN, Constants.SHOW_BUBBLES, "Show the bubbles around anti-bombardment planets"));
        addOptions(
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        if (unitSource != null && Mapper.getUnitSources().contains(unitSource)) game.swapInVariantUnits(unitSource);
    }
}
