...
public class ShuffleBackInUnrevealedObj extends CustomSubcommandData {
    public ShuffleBackInUnrevealedObj() {
        super(Constants.SHUFFLE_BACK_IN_UNREVEALED_OBJ,
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        String id = activeGame.getTopObjective(loc2.getAsInt());
        activeGame.swapObjectiveOut(loc2.getAsInt(), loc1.getAsInt() - 1, id);
