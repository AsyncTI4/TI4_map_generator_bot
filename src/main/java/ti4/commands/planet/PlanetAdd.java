...
public class PlanetAdd extends PlanetAddRemove {
    ...
    public void doAction(Player player, String planet, Game game, GenericInteractionCreateEvent event) {
        ...
        if ((alreadyOwned || player.hasAbility("contagion_blex") || player.hasAbility("plague_reservoir"))
            ...
            MessageHelper.sendMessageToChannelWithButtons(ButtonHelper.getCorrectChannel(player, game), msg10,
        ...
        if (game.getActivePlayerID() != null && !("".equalsIgnoreCase(game.getActivePlayerID()))
            ...
            MessageHelper.sendMessageToChannel(ButtonHelper.getCorrectChannel(player, game), fac
        ...
        if (game.getActivePlayerID() != null && !("".equalsIgnoreCase(game.getActivePlayerID()))
            ...
            MessageHelper.sendMessageToChannelWithButtons(ButtonHelper.getCorrectChannel(player, game), msg2,
                buttons);
        }
        ...
        if (player.hasTech("ie") && unitHolder.getResources() > 0) {
            ...
            buttons.add(Button.danger("deleteButtons", "Decline"));
            MessageHelper.sendMessageToChannel(ButtonHelper.getCorrectChannel(player, game), message, buttons);
        }
