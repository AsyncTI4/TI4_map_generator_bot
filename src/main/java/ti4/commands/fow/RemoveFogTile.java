...
public class RemoveFogTile extends FOWSubcommandData {
    public RemoveFogTile() {
        ...
        addOptions(new OptionData(OptionType.USER, Constants.PLAYER, "Player for which you remove visibility"));
        addOptions(new OptionData(OptionType.STRING, Constants.FACTION_COLOR, "Faction or Color for which you remove visibility").setAutoComplete(true));
    }
