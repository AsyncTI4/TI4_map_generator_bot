...
public class RemoveAllAdjacencyOverrides extends FOWSubcommandData {
    public RemoveAllAdjacencyOverrides() {
        super(Constants.REMOVE_ALL_ADJACENCY_OVERRIDES, "Remove all adjacency overrides from the map.");
