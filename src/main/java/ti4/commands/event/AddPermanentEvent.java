...
public class AddPermanentEvent extends EventSubcommandData {
    public AddPermanentEvent() {
        super(Constants.ADD_EVENT, "Add Event as if it were a Law (Permanent/Temporary)");
