...
public class DrawBlueBackTile extends DiscordantStarsSubcommandData {
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        drawBlueBackTiles(event, game, player, count, includeAllTiles);
    }

    public static void drawBlueBackTiles(GenericInteractionCreateEvent event, Game game, Player player, int count, boolean includeAllTiles) {
