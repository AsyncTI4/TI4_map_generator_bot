...
public class Ban extends GameStateSubcommand {
    ...
    public Ban() {
        ...
        addOptions(new OptionData(OptionType.STRING, Constants.PROMISSORY_NOTE_ID, "Promissory Note").setAutoComplete(true));
        ...
        addOptions(new OptionData(OptionType.STRING, Constants.BAN_COMMODITIES, "Ban Commodities").setAutoComplete(true));
        ...
        addOptions(new OptionData(OptionType.STRING, Constants.BAN_STARTING_TECH, "Ban Starting Technology").setAutoComplete(true));
