...
public class HowToMoveUnits extends HelpSubcommandData {
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        String message = "# So you want to add, remove, or move some units\n" +
            ...
            ">   - Warsun = **ws**\n" +
            ">   - Spacedock = **sd**\n" +
            "> - If you wish to move multiples of a single unit, use **2 carriers** or **8 fighters** (or of course, **2 cv** or **8 ff**)\n" +
            "> - If you wish to move units that are on **planets**, you must specify which planet the unit is on!\n" +
            ...
            "### 5. __faction_or_color__\n> By default, `/move_units` moves your own plastic. You can move other player's plastic (with their permission!) using this argument.\n" +
