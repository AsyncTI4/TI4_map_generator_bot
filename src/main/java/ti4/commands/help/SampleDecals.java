...
class SampleDecals extends Subcommand {
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        for (String d : decals) {
            BufferedImage dread =
                    ImageHelper.read(ResourceHelper.getInstance().getDecalFile("sample/" + d + "_dn_wht.png"));
            ...
            DrawingUtil.superDrawString(
                    graphic,
                    (mid == -1 ? label : label.substring(0, mid)),
                    x + DREADWIDTH / 2,
            ...
            DrawingUtil.superDrawString(
                    ...
                    d,
                    x + DREADWIDTH / 2,
                    y + DREADSUBHIGHT + 2 * LINEHEIGHT + SPACING,
                    Color.WHITE,
                    MapGenerator.HorizontalAlign.Center,
                    MapGenerator.VerticalAlign.Top,
                    stroke,
