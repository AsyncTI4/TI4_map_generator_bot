...
public class TransactionHelper {
        ...
        for (Player player : players) {
            ...
            for (String item : transactionItems) {
                ...
                switch (thingToTransact) {
                    ...
                    case "Frags" -> trans.append(ExploreEmojis.getFragEmoji(furtherDetail)
                        .toString()
            ...
            case "Planets" -> {
                ...
                for (String planet : p1.getPlanetsAllianceMode()) {
                    ...
                    if (ButtonHelper.getUnitHolderFromPlanetName(planet, game)
                        .getUnitCount(UnitType.Mech, p1.getColor()) > 0) {
    ...
    public static void resolveOfferToTransact(Game game, Player player, String buttonID, ButtonInteractionEvent event) {
        ...
        String extraDetail = buttonID.replace(buttonID.split("_")[0] + "_" + item + "_" + sender + "_" + receiver + "_", "");
    ...
    public static void resolveSpecificTransButtonsOld(
        ...
        switch (thingToTrans) {
            ...
            case "PNs" -> {
                ...
                String message = p1.getRepresentationUnfogged() + ", please choose the promissory note you wish to send.";
