...
public class ButtonHelperActionCards {
    ...
    public static void resolveScuttleStart(Player player, Game game, ButtonInteractionEvent event, String buttonID) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                ...
                player.getRepresentationUnfogged()
                        + " Use buttons to select the system containing a unit you wish to _Scuttle_.",
                buttons);
    ...
    public static void resolveLuckyShotStart(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                event.getChannel(),
                player.getRepresentationUnfogged() + " Use buttons to select system to _Lucky Shot_ at.",
                buttons);
        ButtonHelper.deleteMessage(event);
    }
    ...
    public static void resolveScuttleTileSelection(
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                event.getChannel(),
                player.getRepresentationUnfogged() + " Use buttons to select which unit to _Scuttle_.",
                buttons);
        ButtonHelper.deleteMessage(event);
    }
    ...
    public static void resolveLuckyShotTileSelection(
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                event.getChannel(),
                player.getRepresentationUnfogged()
                        + ", use buttons to select which unit you wish to hit with _Lucky Shot_.",
                buttons);
        ButtonHelper.deleteMessage(event);
    }
    ...
    public static void resolveCounterStroke(Game game, Player player, ButtonInteractionEvent event) {
        RemoveCommandCounterService.fromTile(
                event, player.getColor(), game.getTileByPosition(game.getActiveSystem()), game);
    ...
    public static void resolveCounterStroke(Game game, Player player, ButtonInteractionEvent event, String buttonID) {
        RemoveCommandCounterService.fromTile(
                event, player.getColor(), game.getTileByPosition(buttonID.split("_")[1]), game);
    ...
    public static void resolveForwardSupplyBaseStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + ", choose who should get the other trade good.",
                buttons);
    }
    ...
    public static void resolveReparationsStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + " tell the bot who took the planet from you.",
                buttons);
    }
    ...
    public static void resolveDiplomaticPressureStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged()
                        + ", tell the bot who you wish to force to give you a promissory note.",
                buttons);
    }
    ...
    public static void resolveUprisingStep1(Player player, Game game, ButtonInteractionEvent event, String buttonID) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged()
                        + ", tell the bot whose planet you wish to _Uprise_ against their oppressors.",
                buttons);
    }
    ...
    public static void resolveAssRepsStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + ", tell the bot who you wish to be assassinated.",
                buttons);
    }
    ...
    public static void resolveSignalJammingStep1(
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged()
                        + " tell the bot which player you wish to have a command token placed.",
                buttons);
    }
    ...
    public static void resolveMicrometeoroidStormStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged()
                        + " tell the bot whose fighters you wish to experience inclement space weather.",
                buttons);
    }
    ...
    public static void resolveProbeStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + " tell the bot which tile you wish to _Exploration Probe_.",
                buttons);
    }
    ...
    public static void resolveCrippleDefensesStep1(
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged()
                        + " tell the bot which player controls the planet you wish to cripple.",
                buttons);
    }
    ...
    public static void resolveInfiltrateStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged()
                        + " tell the bot which player controls the planet you are infiltrating.",
                buttons);
    }
    ...
    public static void resolveSpyStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged()
                        + " tell the bot which player you wish to purloin a random action card from.",
                buttons);
    }
    ...
    public static void resolvePSStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + " tell the bot which strategy card(s) you used to have.",
                buttons);
    }
    ...
    public static void resolveInsubStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged()
                        + ", please tell the bot which player you wish to remove a command token from the tactic pool of.",
                buttons);
    }
    ...
    public static void resolveUnstableStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged()
                        + ", please tell the bot which player owns the to-be _Unstable Planet_.",
                buttons);
    }
    ...
    public static void resolveABSStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged()
                        + " tell the bot which player will have discovered some _Ancient Burial Sites_ upon their cultural planets.",
                buttons);
    }
    ...
    public static void resolveSalvageStep1(Player player, Game game, ButtonInteractionEvent event, String buttonID) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + " tell the bot who you're playing _Salvage_ on.",
                buttons);
    }
    ...
    public static void resolveInsubStep2(Player player, Game game, ButtonInteractionEvent event, String buttonID) {
        ...
        MessageHelper.sendMessageToChannel(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + " you removed 1 command from the tactic pool of "
    ...
    public static void resolveDiplomaticPressureStep2(
        ...
        MessageHelper.sendMessageToChannel(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + ", buttons for resolving _Diplomatic Pressure_ have been sent to "
                        + p2.getFactionEmojiOrColor() + ".");
        ButtonHelper.deleteMessage(event);
    }
    ...
    public static void resolveReparationsStep2(
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + ", select the planet you wish to exhaust.",
                buttons);
    }
    ...
    public static void resolveInsiderInformation(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannel(
                event.getChannel(),
                "Sent info for the top card of the agenda deck to " + player.getFactionEmojiOrColor()
                        + " `#cards-info` thread.");
        ButtonHelper.deleteMessage(event);
    }
    ...
    public static void resolveSeizeArtifactStep2(
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + " select the relic fragment you wish to nab.",
                buttons);
    ...
    public static void resolveSignalJammingStep3(
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + " select the tile you wish to jam.",
                buttons);
    }
    ...
    public static void resolveReactorMeltdownStep2(
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + ", please select the space dock you wish to melt.",
                buttons);
    }
    ...
    public static void resolvePlagueStep2(Player player, Game game, ButtonInteractionEvent event, String buttonID) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + " select the planet you wish to _Plague_.",
                buttons);
    }
    ...
    public static void resolveMicrometeoroidStormStep2(
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + " select the tile you wish to storm.",
                buttons);
    }
    ...
    public static void resolveCrippleStep2(Player player, Game game, ButtonInteractionEvent event, String buttonID) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + ", select the planet you wish to cripple.",
                buttons);
    }
    ...
    public static void resolveInfiltrateStep2(Player player, Game game, ButtonInteractionEvent event, String buttonID) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged() + ", select the planet you wish to _Infiltrate_.",
                buttons);
    }
    ...
    public static void resolveDecoyOperationStep1(
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged()
                        + ", please tell the bot which planet you wish to resolve _Decoy Operations_ on.",
                buttons);
    }
    ...
    public static void resolveTacticalBombardmentStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                player.getCorrectChannel(),
                player.getRepresentationUnfogged()
                        + ", please tell the bot which tile you wish to tactically bombard in.",
                buttons);
    }
    ...
    public static void resolveUnstableStep3(Player player, Game game, ButtonInteractionEvent event, String buttonID) {
        ...
        if (p2.hasInf2Tech()) {
            ...
            if (p2.hasAbility("amalgamation")
                    && game.getTileFromPlanet(planet)
                                    .getUnitHolders()
                                    .get(planet)
                                    .getUnitCount(UnitType.Mech, p2.getColor())
                            > 0
            ...
            if (p2.hasAbility("amalgamation")
                    && (ButtonHelper.doesPlayerHaveFSHere("cabal_flagship", p2, tile)
        ...
        RemoveUnitService.removeUnits(
                event, game.getTileFromPlanet(planet), game, p2.getColor(), amountToKill + " inf " + planet);
        if (game.isFowMode()) {
            MessageHelper.sendMessageToChannel(
                    player.getCorrectChannel(),
    ...
    public static void getPlagiarizeButtons(ButtonInteractionEvent event, Player player, Game game) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                event.getChannel(),
                "Select the technology you wish to acquire by violating intellectual property law.",
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                event.getChannel(),
                "Click the names of the planets you wish to exhaust to pay the 5 influence.",
                buttons);
        ButtonHelper.deleteMessage(event);
    }
    ...
    public static void economicInitiative(Player player, Game game, ButtonInteractionEvent event) {
        ...
        MessageHelper.sendMessageToChannel(
                event.getChannel(), player.getFactionEmoji() + " readied each of their cultural planets.");
        ButtonHelper.deleteMessage(event);
    }
