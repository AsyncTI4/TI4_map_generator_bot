...
public class ButtonHelperActionCards {
    ...
    public static void resolveAssRepsStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        ButtonHelper.deleteMessage(event);
        MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(),
            player.getRepresentationUnfogged() + ", please tell the bot who you wish to be assassinated (in game).", buttons);
    }
    ...
    public static void resolveSeizeArtifactStep1(Player player, Game game, ButtonInteractionEvent event, String kolleccTech) {
        ...
        ButtonHelper.deleteMessage(event);
        MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(),
            player.getRepresentationUnfogged() + ", please tell the bot which neighbor you wish to loot.",
            buttons);
    }
    ...
    public static void resolvePlagueStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        ButtonHelper.deleteMessage(event);
        MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(),
            player.getRepresentationUnfogged() + ", please tell the bot who controls the planet that you wish to _Plague_.",
            buttons);
    }
    ...
    public static void resolveMicrometeoroidStormStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        ButtonHelper.deleteMessage(event);
        MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(),
            player.getRepresentationUnfogged() + ", please tell the bot whose fighters you wish to experience inclement space weather.",
            buttons);
    }
    ...
    public static void resolveGhostShipStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        ButtonHelper.deleteMessage(event);
        MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(),
            player.getRepresentationUnfogged() + ", please tell the bot which tile you wish to place the _Ghost Ship_ in.",
            buttons);
    }
    ...
    public static void resolveProbeStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        ButtonHelper.deleteMessage(event);
        MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(),
            player.getRepresentationUnfogged() + ", please tell the bot which tile you wish to _Exploration Probe_.", buttons);
    }
    ...
    public static void resolveCrippleDefensesStep1(Player player, Game game, ButtonInteractionEvent event, String buttonID) {
        ...
        ButtonHelper.deleteMessage(event);
        MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(),
            player.getRepresentationUnfogged() + ", please tell the bot which player controls the planet whose Defenses you wish to Cripple.",
            buttons);
    }
    ...
    public static void resolveInfiltrateStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        ButtonHelper.deleteMessage(event);
        MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(),
            player.getRepresentationUnfogged() + ", please tell the bot which player controls the planet you are Infiltrating.",
            buttons);
    }
    ...
    public static void resolveSpyStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        ButtonHelper.deleteMessage(event);
        MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(),
            player.getRepresentationUnfogged() + ", please tell the bot which player you wish to purloin a random action card from.",
            buttons);
    }
    ...
    public static void resolvepPsionicHammerStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        if (buttons.isEmpty()) {
            ...
            MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(),
                player.getRepresentationUnfogged() + ", please tell the bot which player you wish to see a random secret objective of.",
                buttons);
        }
    }
    ...
    public static void resolveABSStep1(Player player, Game game, ButtonInteractionEvent event) {
        ...
        ButtonHelper.deleteMessage(event);
        MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(),
            player.getRepresentationUnfogged() + ", please tell the bot which player will have discovered some _Ancient Burial Sites_ upon their cultural planets.",
            buttons);
    }
    ...
    public static void resolveSalvageStep1(Player player, Game game, ButtonInteractionEvent event, String buttonID) {
        ...
        ButtonHelper.deleteMessage(event);
        MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(),
            player.getRepresentationUnfogged() + ", please tell the bot who you're playing _Salvage_ on.", buttons);
    }
