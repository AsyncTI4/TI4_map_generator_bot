...
public class ButtonHelperFactionSpecific {
    ...
    public static void resolveExpLook(Player player, Game game, GenericInteractionCreateEvent event,
        ...
        MessageHelper.sendMessageToChannel(event.getMessageChannel(),
            "top of " + traitNameWithEmoji + " exploration deck has been set to " + playerFactionNameWithEmoji
                + " `#Cards Info` thread.");
    }
    ...
    public static void resolveBranchOffice(String buttonID, ButtonInteractionEvent event, Game game,
        ...
        switch (pnID) {
            ...
            case "dspnveld4" -> {
                ...
                nameBonus = "n Orbital Shipyard (+" + Emojis.Resources_1 + ")";
            }
        }
        MessageHelper.sendMessageToChannel(player.getCorrectChannel(),
            "Attached a" + nameBonus + " Branch Office to " + Helper.getPlanetRepresentation(planet, game));
