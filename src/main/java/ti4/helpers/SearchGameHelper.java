...
public class SearchGameHelper {
    ...
    public static String getTotalCompletedNOngoingGames(List<User> users, GenericInteractionCreateEvent event) {
        ...
        for (User user : users) {
            int ongoingAmount =
                    searchGames(user, event, false, false, false, true, false, true, true, true);
            int completedAndOngoingAmount =
                    searchGames(user, event, false, true, false, true, false, true, true, true);
            ...
            if (completedGames > 0) {
                ...
                List<Integer> days = getGameDaysLength(
                        user, event, false, true, false, true, false, true, true, true);
                for (int day : days) {
                    sb.append(" ").append(day);
                }
                sb.append("\n");
                double getWinPercentage = getWinPercentage(
                        user, event, false, true, false, true, false, true, true, true);
