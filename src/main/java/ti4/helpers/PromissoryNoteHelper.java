...
public class PromissoryNoteHelper {
    ...
    public static void resolvePNPlay(String id, Player player, Game game, GenericInteractionCreateEvent event) {
        ...
        if ("greyfire".equalsIgnoreCase(id)) {
            ...
            String message =
                    player.getRepresentationUnfogged() + " select planet you wish to use _Greyfire Mutagen_ on.";
            MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(), message, buttons);
        }
        ...
        if ("sigma_raghs_call".equalsIgnoreCase(id)) {
            String message = player.getRepresentationUnfogged()
                    + ", please select planet to _Ragh's Call_ on. You will need to ready the planet manually if applicable.";
            MessageHelper.sendMessageToChannelWithButtons(
                    player.getCorrectChannel(),
                    message,
                    ButtonHelperFactionSpecific.getRaghsCallButtons(
        ...
        if (id.contains("rider")) {
            ...
            MessageHelper.sendMessageToChannelWithFactionReact(
                    player.getCorrectChannel(),
                    player.getRepresentation() + "Please select your Rider target",
                    game,
                    player,
                    riderButtons);
        ...
        TemporaryCombatModifierModel possibleCombatMod = CombatTempModHelper.getPossibleTempModifier(
                Constants.PROMISSORY_NOTES, pn.getAlias(), player.getNumberTurns());
