...
class JimboButtons {
        ...
        private static final Button TRANSFORM_ACTION = Buttons.blue(JimboConst.transformAction, "Transform the map (rotate/shift)");
        ...
        private static final Button TRANSFORM_ROTATE_CCW = Buttons.green(JimboConst.transformRotate + "ccw", "Rotate counter-clockwise"); // . . TODO (Jazz): add emoji
        private static final Button TRANSFORM_TRANSLATE_0 = Buttons.blue(JimboConst.transformTranslate + "0", "Shift the map UP"); // . . . . . TODO (Jazz): add emoji
        private static final Button TRANSFORM_TRANSLATE_1 = Buttons.blue(JimboConst.transformTranslate + "1", "Shift the map UP & RIGHT"); // . TODO (Jazz): add emoji
        private static final Button TRANSFORM_TRANSLATE_2 = Buttons.blue(JimboConst.transformTranslate + "2", "Shift the map DOWN & RIGHT"); // TODO (Jazz): add emoji
        private static final Button TRANSFORM_TRANSLATE_3 = Buttons.blue(JimboConst.transformTranslate + "3", "Shift the map DOWN"); // . . . . TODO (Jazz): add emoji
        private static final Button TRANSFORM_TRANSLATE_4 = Buttons.blue(JimboConst.transformTranslate + "4", "Shift the map DOWN & LEFT"); // . TODO (Jazz): add emoji
        private static final Button TRANSFORM_TRANSLATE_5 = Buttons.blue(JimboConst.transformTranslate + "5", "Shift the map UP & LEFT"); // . . TODO (Jazz): add emoji
        ...
        public static List<Button> getMenuButtons(String submenu) {
                ...
                List<Button> buttons = switch (submenu) {
                        ...
                        case JimboConst.transformAction -> List.of(
                                MAIN_PAGE,
                                TRANSFORM_ROTATE_CW,
