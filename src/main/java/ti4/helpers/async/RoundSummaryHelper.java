...
public class RoundSummaryHelper {
    ...
    public static void storeEndOfRoundSummary(
        ...
        MessageHelper.sendMessageToChannelWithButton(
                playerChannel, resolvePlayerEmoji(player) + " stored an end of round summary", Buttons.EDIT_SUMMARIES);
        MessageHelper.sendMessageToChannel(game.getMainGameChannel(), "A player has stored an end of round summary.");
    }
