...
public class ButtonHelperHeroes {
    ...
    public static void resolveKhraskHeroStep2(Player player, Game activeGame, ButtonInteractionEvent event,
            String buttonID) {
        List<Button> buttons = new ArrayList<>();
    ...
    public static void resolveKhraskHeroStep3Exhaust(Player player, Game activeGame, ButtonInteractionEvent event,
            String buttonID) {
    ...
    public static void resolveKhraskHeroStep4Exhaust(Player player, Game activeGame, ButtonInteractionEvent event,
            String buttonID) {
        Player p2 = activeGame.getPlayerFromColorOrFaction(buttonID.split("_")[1]);
    ...
    public static void resolveAxisHeroStep2(Player player, Game activeGame, ButtonInteractionEvent event,
            String buttonID) {
        List<Button> buttons = new ArrayList<>();
    ...
    public static void resolveAxisHeroStep3(Player player, Game activeGame, ButtonInteractionEvent event,
            String buttonID) {
        String shipOrder = buttonID.split("_")[1];
    ...
    public static void resolveKhraskHeroStep3Ready(Player player, Game activeGame, ButtonInteractionEvent event,
            String buttonID) {
        Player p2 = activeGame.getPlayerFromColorOrFaction(buttonID.split("_")[1]);
    ...
    public static void resolveKhraskHeroStep4Ready(Player player, Game activeGame, ButtonInteractionEvent event,
            String buttonID) {
        Player p2 = activeGame.getPlayerFromColorOrFaction(buttonID.split("_")[1]);
        String planet = buttonID.split("_")[2];
        String planetRep = Helper.getPlanetRepresentation(planet, activeGame);
    ...
    public static void resolveAttachAttachment(Player player, Game activeGame, String buttonID,
    ...
    public static void findAttachmentInDeck(Player player, Game activeGame, String buttonID,
            ButtonInteractionEvent event) {
        ...
        while (!foundOne && counter < 40) {
            ...
            if (explore.getResolution().equalsIgnoreCase("attach")) {
                ...
                MessageHelper.sendMessageToChannel(channel, msg,
                        getAttachmentAttach(activeGame, player, type, explore.getAttachmentId().get()));
                return;
            }
        }
    ...
    public static void resolveFlorzenHeroStep2(Player player, Game activeGame, ButtonInteractionEvent event,
            String buttonID) {
        String planet = buttonID.split("_")[1];
    ...
    public static void resolveTnelisHeroAttach(Player tnelis, Game activeGame, String soID,
            ButtonInteractionEvent event) {
    ...
    public static List<Button> getTilesToGhotiHeroIn(Player player, Game activeGame,
    ...
    public static List<Button> getUnitsToGlimmersHero(Player player, Game activeGame,
    ...
    public static List<Button> getTilesToGlimmersHeroIn(Player player, Game activeGame,
            GenericInteractionCreateEvent event) {
        String finChecker = "FFCC_" + player.getFaction() + "_";
        List<Button> buttons = new ArrayList<>();
        for (Map.Entry<String, Tile> tileEntry : new HashMap<>(activeGame.getTileMap()).entrySet()) {
    ...
    public static void freeSystemsHeroPlanet(String buttonID, ButtonInteractionEvent event, Game activeGame,
            Player player) {
        String planet = buttonID.split("_")[1];
        UnitHolder unitHolder = activeGame.getPlanetsInfo().get(planet);
        Planet planetReal = (Planet) unitHolder;
        ...
        MessageHelper.sendMessageToChannel(event.getChannel(),
                "Attached Free Systems Hero to " + Helper.getPlanetRepresentation(planet, activeGame));
        event.getMessage().delete().queue();
    }
    ...
    public static List<Button> getButtonsForGheminaLadyHero(Player player, Game activeGame) {
        String finChecker = "FFCC_" + player.getFaction() + "_";
        List<Button> buttons = new ArrayList<>();
        List<Tile> tilesWithBombard = ButtonHelper.getTilesOfPlayersSpecificUnits(activeGame, player, UnitType.Lady,
                UnitType.Flagship);
        Set<String> adjacentTiles = FoWHelper.getAdjacentTilesAndNotThisTile(activeGame,
                tilesWithBombard.get(0).getPosition(), player, false);
        for (Tile tile : tilesWithBombard) {
            adjacentTiles
                    .addAll(FoWHelper.getAdjacentTilesAndNotThisTile(activeGame, tile.getPosition(), player, false));
        }
                ...
                if (unitHolder instanceof Planet planet) {
                    if (!player.getPlanetsAllianceMode().contains(planet.getName())
                        ...
                        buttons.add(Button.success(finChecker + "gheminaLadyHero_" + planet.getName(),
                                Helper.getPlanetRepresentation(planet.getName(), activeGame)));
                    }
                }
            }
        }
    ...
    public static void resolveGheminaLadyHero(Player player, Game activeGame, ButtonInteractionEvent event,
            String buttonID) {
    ...
    public static void resolveGheminaLordHero(String buttonID, String ident, Player player, Game activeGame,
            ButtonInteractionEvent event) {
        String planet = buttonID.split("_")[1];
    ...
    public static List<Button> getSaarHeroButtons(Game activeGame, Player player) {
        ...
        for (Tile tile1 : ButtonHelper.getTilesOfPlayersSpecificUnits(activeGame, player, UnitType.Spacedock)) {
            for (String tile2Pos : FoWHelper.getAdjacentTilesAndNotThisTile(activeGame, tile1.getPosition(), player,
                    false)) {
    ...
    public static void resolveSaarHero(Game activeGame, Player player, ButtonInteractionEvent event, String buttonID) {
        ...
        MessageHelper.sendMessageToChannel(event.getMessageChannel(),
                ButtonHelper.getIdent(player) + " removed all opposing infantry and fighters in "
                        + tile.getRepresentationForButtons(activeGame, player) + " using Saar hero");
        event.getMessage().delete().queue();
    }

    public static void resolveArboHeroBuild(Game activeGame, Player player, ButtonInteractionEvent event,
            String buttonID) {
        String pos = buttonID.split("_")[1];
        List<Button> buttons;
    ...
    public static void purgeCeldauriHero(Player player, Game activeGame, ButtonInteractionEvent event,
        ...
        for (UnitHolder uH : tile.getPlanetUnitHolders()) {
            if (player.getPlanets().contains(uH.getName())) {
                ...
                Button sdButton = Button.success("winnuStructure_sd_" + planet,
                        "Place A SD on " + Helper.getPlanetRepresentation(planet, activeGame));
        ...
        String message3 = "The bot believes you have " + Helper.getProductionValue(player, activeGame, tile, false)
                + " PRODUCTION value in this system\n";
        if (Helper.getProductionValue(player, activeGame, tile, false) > 0
    ...
    public static void resolveNekroHeroStep2(Player player, Game activeGame, ButtonInteractionEvent event,
            String buttonID) {
        String planet = buttonID.split("_")[1];
    ...
    public static List<Button> getCabalHeroButtons(Player player, Game activeGame) {
        ...
        for (Tile tile : adjTiles) {
            empties.add(Button.primary(finChecker + "cabalHeroTile_" + tile.getPosition(),
                    "Roll for units in " + tile.getRepresentationForButtons(activeGame, player)));
        }
        return empties;
    }
    ...
    public static void executeCabalHero(String buttonID, Player player, Game activeGame, ButtonInteractionEvent event) {
        ...
        for (Player p2 : activeGame.getRealPlayers()) {
            ...
            if (FoWHelper.playerHasShipsInSystem(p2, tile)
                    && !ButtonHelperFactionSpecific.isCabalBlockadedByPlayer(p2, activeGame, player)) {
    ...
    public static List<Button> getEmpyHeroButtons(Player player, Game activeGame) {
        ...
        for (Tile tile : activeGame.getTileMap().values()) {
            ...
            empties.add(Button.primary(finChecker + "exploreFront_" + tile.getPosition(),
                    "Explore " + tile.getRepresentationForButtons(activeGame, player)));
        }
        return empties;
    }
    ...
    public static void resolveNaaluHeroSend(Player p1, Game activeGame, String buttonID, ButtonInteractionEvent event) {
        ...
        if ((id.endsWith("_sftt") || id.endsWith("_an")) && !promissoryNoteOwner.equals(p2.getFaction())
                ...
                && !p2.isPlayerMemberOfAlliance(activeGame.getPlayerFromColorOrFaction(promissoryNoteOwner))) {
    ...
    public static void offerStealRelicButtons(Game activeGame, Player player, String buttonID,
            ButtonInteractionEvent event) {
        ButtonHelper.deleteTheOneButton(event);
        String faction = buttonID.split("_")[1];
    ...
    public static void stealRelic(Game activeGame, Player player, String buttonID, ButtonInteractionEvent event) {
        ...
        String msg = ButtonHelper.getIdentOrColor(player, activeGame) + " stole " + Mapper.getRelic(relic).getName()
                + " from " + ButtonHelper.getIdentOrColor(p2, activeGame);
        if (activeGame.isFoWMode()) {
            MessageHelper.sendMessageToChannel(ButtonHelper.getCorrectChannel(p2, activeGame), msg);
        }
    ...
    public static void augersHeroResolution(Player player, Game activeGame, String buttonID,
            ButtonInteractionEvent event) {
        List<Button> buttons = new ArrayList<>();
        if ("1".equalsIgnoreCase(buttonID.split("_")[1])) {
    ...
    public static void olradinHeroFlipPolicy(String buttonID, ButtonInteractionEvent event, Game activeGame,
            Player player) {
    ...
    public static void lastStepOfYinHero(String buttonID, ButtonInteractionEvent event, Game activeGame, Player player,
            String trueIdentity) {
        ...
        for (Player player2 : activeGame.getRealPlayers()) {
            ...
            if (numInf > 0 || numMechs > 0) {
                ...
                if (!activeGame.isFoWMode()) {
                    ...
                    String threadName = activeGame.getName() + "-yinHero-" + activeGame.getRound() + "-planet-" + planet
        ...
        for (String pos2 : FoWHelper.getAdjacentTiles(activeGame, pos1, player, false)) {
            ...
            if (FoWHelper.otherPlayersHaveShipsInSystem(player, tile2, activeGame)) {
                buttons.add(Button.secondary(finChecker + "mahactBenedictionFrom_" + pos1 + "_" + pos2,
                        tile2.getRepresentationForButtons(activeGame, origPlayer)));
            }
        }
        return buttons;
    }
    ...
    public static void resolveAJolNarSwapStep1(Player player, Game activeGame, String buttonID,
            ButtonInteractionEvent event) {
    ...
    public static void resolveAJolNarSwapStep2(Player player, Game activeGame, String buttonID,
            ButtonInteractionEvent event) {
    ...
    public static void mahactBenediction(String buttonID, ButtonInteractionEvent event, Game activeGame,
            Player player) {
        String pos1 = buttonID.split("_")[1];
        String pos2 = buttonID.split("_")[2];
        Tile tile1 = activeGame.getTileByPosition(pos1);
    ...
    public static void getGhostHeroTilesStep2(Game activeGame, Player player, ButtonInteractionEvent event,
            String buttonID) {
        String pos1 = buttonID.split("_")[1];
        List<Button> buttons = new ArrayList<>();
        Tile tile1 = activeGame.getTileByPosition(pos1);
    ...
    public static void resolveWinnuHeroSC(Player player, Game activeGame, ButtonInteractionEvent event,
            String buttonID) {
    ...
    public static void resolveGhostHeroStep2(Game activeGame, Player player, ButtonInteractionEvent event,
            String buttonID) {
        ...
        MessageHelper.sendMessageToChannel(ButtonHelper.getCorrectChannel(player, activeGame),
                player.getRepresentation(true, true) + " Chose to swap "
                        + tile2.getRepresentationForButtons(activeGame, player) + " with "
                        + tile.getRepresentationForButtons(activeGame, player));
        event.getMessage().delete().queue();
    }
}