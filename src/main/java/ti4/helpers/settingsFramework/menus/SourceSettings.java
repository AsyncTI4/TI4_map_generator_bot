...
public class SourceSettings extends SettingsMenu {
    ...
    public SourceSettings(Game game, JsonNode json, SettingsMenu parent) {
        ...
        miltymod.setExtraInfo(
                "NOTE: this is NOT \"milty draft\", this is a homebrew mod that replaces components in the game");
    ...
    public List<ComponentSource> getTileSources() {
        ...
        if (codexes.isVal())
            sources.addAll(List.of(ComponentSource.codex1, ComponentSource.codex2, ComponentSource.codex3));
