            ...
            for (String existingPosition : distancesCopy.keySet()) {
                ...
                if (!existingPosition.equalsIgnoreCase(tilePosition)) {
                    if (tile == null
                        ...
                        || (player != null && FoWHelper.otherPlayersHaveShipsInSystem(player, tile, game) && !player.hasTech("lwd") && !player.hasTech("absol_lwd") && tile2 != null && !ButtonHelper.doesPlayerHaveFSHere("yssaril_flagship", player, tile2))
