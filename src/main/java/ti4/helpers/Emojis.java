...
public class Emojis {
    ...
    public static final String ArgentHero = "";
    public static final String CabalHero = "";
    public static final String CreussHero = "";
    public static final String EmpyreanHero = "";
    public static final String HacanHero = "";
    public static final String JolnarHero = "";
    public static final String KeleresHeroKuuasi = "";
    public static final String KeleresHeroOdlynn = "";
    public static final String KeleresHeroHarka = "";
    public static final String L1z1xHero = "";
    public static final String LetnevHero = "";
    public static final String MahactHero = "";
    public static final String MentakHero = "";
    public static final String MuaatHero = "";
    public static final String NaaluHero = "";
    public static final String NaazHero = "";
    public static final String NekroHero = "";
    public static final String NomadHero = "";
    public static final String SardakkHero = "";
    public static final String SaarHero = "";
    public static final String SolHero = "";
    public static final String TitansHero = "";
    public static final String WinnuHero = "";
    public static final String XxchaHero = "";
    public static final String YinHero = "";
    public static final String YssarilHero = "";
