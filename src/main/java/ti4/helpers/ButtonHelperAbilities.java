...
public class ButtonHelperAbilities {
    ...
    public static void resolveFacsimileStep2(Game game, Player player, ButtonInteractionEvent event, String buttonID) {
        ...
        UnitModifier.parseAndUpdateGame(event, player.getColor(), tile, unit, game);
    ...
    public static void mercenariesStep4(Game game, Player player, ButtonInteractionEvent event, String buttonID) {
        ...
        UnitModifier.parseAndUpdateGame(event, player.getColor(), tile2, fighters + " fighters", game);
        UnitModifier.parseAndUpdateGame(event, p2.getColor(), tile, fighters + " fighters", game);
    ...
    public static void orbitalMechDrop(String buttonID, ButtonInteractionEvent event, Game game, Player player) {
        String planet = buttonID.split("_")[1];
        UnitModifier.parseAndUpdateGame(event, player.getColor(), game.getTileFromPlanet(planet), "1 mech " + planet, game);
    ...
    public static void resolveOlradinConnectStep2(Player player, Game game, String buttonID,
        ...
        UnitModifier.parseAndUpdateGame(event, player.getColor(), game.getTileFromPlanet(planet1), "inf " + planet1,
            game);
        UnitModifier.parseAndUpdateGame(event, player.getColor(), game.getTileFromPlanet(planet2), "inf " + planet2,
            game);
    ...
    public static void meteorSlings(Player player, String buttonID, Game game, ButtonInteractionEvent event) {
        ...
        UnitModifier.parseAndUpdateGame(event, player.getColor(), game.getTileFromPlanet(planet), "1 inf " + planet, game);
        MessageHelper.sendMessageToChannel(event.getMessageChannel(), msg);
    }
    ...
    public static void replaceSleeperWith(String buttonID, ButtonInteractionEvent event, Game game, Player player) {
        ...
        if ("mech".equalsIgnoreCase(unit)) {
            UnitModifier.parseAndUpdateGame(event, player.getColor(), game.getTile(AliasHandler.resolveTile(planetName)), "mech " + planetName + ", inf " + planetName, game);
            ...
            UnitModifier.parseAndUpdateGame(event, player.getColor(), game.getTile(AliasHandler.resolveTile(planetName)), "pds " + planetName, game);
    ...
    public static void resolveMitosisMechPlacement(String buttonID, ButtonInteractionEvent event, Game game, Player player) {
        ...
        UnitModifier.parseAndUpdateGame(event, player.getColor(), tile, "mech " + uH.replace("space", ""), game);
    ...
    public static void resolveFollowUpIndoctrinationQuestion(Player player, Game game, String buttonID, ButtonInteractionEvent event) {
        ...
        Tile tile = game.getTileFromPlanet(planet);
        UnitModifier.parseAndUpdateGame(event, player.getColor(), tile, "1 " + unit + " " + planet, game);
        for (Player p2 : game.getPlayers().values()) {
            ...
            if (FoWHelper.playerHasInfantryOnPlanet(p2, tile, planet) && !player.getAllianceMembers().contains(p2.getFaction())) {
                UnitModifier.parseAndUpdateGame(event, p2.getColor(), tile, "1 infantry " + planet, game);
                break;
            }
        }
