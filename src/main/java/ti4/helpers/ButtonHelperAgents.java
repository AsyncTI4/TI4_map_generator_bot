...
public class ButtonHelperAgents {
    ...
    public static void cabalAgentInitiation(Game game, Player p2) {
        for (Player cabal : game.getRealPlayers()) {
            ...
            if (cabal.hasUnexhaustedLeader("cabalagent")) {
                List<Button> buttons = new ArrayList<>();
                String msg = cabal.getRepresentationUnfogged() + " you have the ability to use "
    ...
    public static void exhaustAgent(String buttonID, GenericInteractionCreateEvent event, Game game, Player player) {
        ...
        if ("augersagent".equalsIgnoreCase(agent)) {
            ...
            MessageHelper.sendMessageToChannel(
                    p2.getCorrectChannel(),
                    player.getFactionEmojiOrColor() + " gained 2 trade goods from " + ssruuClever + "Clodho, the Ilyxum"
        ...
        if ("vaylerianagent".equalsIgnoreCase(agent)) {
            ...
            if (rest.contains("_")) {
                ...
                message = trueIdentity + " select the faction on which you wish to use " + ssruuClever
                        + "Yvin Korduul, the Vaylerian" + ssruuSlash + " agent.";
        ...
        if ("muaatagent".equalsIgnoreCase(agent)) {
            ...
            message = "Use buttons to select which tile to " + ssruuClever + "Umbat, the Muaat" + ssruuSlash
                    + " agent, in";
            List<Tile> tiles =
        ...
        if ("arborecagent".equalsIgnoreCase(agent)) {
            ...
            if (p2 == null) return;
            channel = p2.getCorrectChannel();
            message = "Use buttons to select which tile to use " + ssruuClever + "Letani Ospha, the Arborec"
                    + ssruuSlash + " agent, in";
        ...
        if (event instanceof ButtonInteractionEvent buttonEvent) {
            ...
            if (!actionRow2.isEmpty()
                    && !exhaustedMessage.contains("select the user of the agent")
        ...
        for (Player p2 : game.getRealPlayers()) {
            if (p2.hasTech("tcs") && !p2.getExhaustedTechs().contains("tcs")) {
                ...
                buttons2.add(Buttons.green(
                        "exhaustTCS_" + agent + "_" + player.getFaction(),
    ...
    public static void resolveCheiranAgentStep1(Player cheiran, Game game, String buttonID) {
        ...
        String msg =
                player.getRepresentationUnfogged() + ", choose the tile you wish to remove your command token from.";
    ...
    public static void resolveFlorzenAgentStep2(
        ...
        String msg =
                player.getRepresentationUnfogged() + " choose the adjacent planet you wish to put the attachment on";
        MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(), msg, buttons);
        ButtonHelper.deleteMessage(event);
    }
    ...
    public static void resolveCheiranAgentStep2(
        ...
        String msg = player.getRepresentationUnfogged()
                + " choose the adjacent tile that you wish to place your command token in.";
        MessageHelper.sendMessageToChannelWithButtons(player.getCorrectChannel(), msg, buttons);
        ButtonHelper.deleteMessage(event);
    }
    ...
    public static void ghotiAgentForTg(ButtonInteractionEvent event, Game game, Player player) {
        ...
        String msg = "Used " + (player.hasUnexhaustedLeader("yssarilagent") ? "Clever Clever " : "")
                ...
                + " agent, to gain 1 trade good (" + cTG + "->" + fTG + "). ";
    ...
    public static void offerMoveGloryOptions(Game game, Player player, GenericInteractionCreateEvent event) {
        String msg =
                player.getRepresentationUnfogged() + " use buttons to select system to move a **Glory** token from.";
        Tile tileAS = game.getTileByPosition(game.getActiveSystem());
        List<Button> buttons = new ArrayList<>();
    ...
    public static void resolveArtunoCheck(Player player, int tg) {
        if (player.hasUnexhaustedLeader("nomadagentartuno")) {
            List<Button> buttons = new ArrayList<>();
            buttons.add(Buttons.green(
                    "exhaustAgent_nomadagentartuno_" + tg,
            ...
            MessageHelper.sendMessageToChannelWithButtons(
                    ...
                    player.getRepresentationUnfogged()
                            ...
                            + (player.hasUnexhaustedLeader("yssarilagent") ? "Clever Clever " : "")
                            + "Artuno the Betrayer the Betrayer, a Nomad"
    ...
    public static void yinAgent(String buttonID, ButtonInteractionEvent event, Game game, Player player) {
        ...
        MessageHelper.sendMessageToChannelWithButtons(
                event.getMessageChannel(),
                player.getRepresentationUnfogged() + " Use buttons to select faction to give "
                        + (player.hasUnexhaustedLeader("yssarilagent") ? "Clever Clever " : "")
