...
public class RedTileDraftItem extends TileDraftItem {

    public RedTileDraftItem(String itemId) {
        super(DraftCategory.REDTILE, itemId);
    }
    ...
    public static List<DraftItem> buildAllDraftableItems(MiltyDraftManager draftManager) {
        ...
        for (MiltyDraftTile tile : draftManager.getRed()) {
            allItems.add(generate(DraftCategory.REDTILE, tile.getTile().getTileID()));
        }
        DraftErrataModel.filterUndraftablesAndShuffle(allItems, DraftCategory.REDTILE);
        return allItems;
    }
