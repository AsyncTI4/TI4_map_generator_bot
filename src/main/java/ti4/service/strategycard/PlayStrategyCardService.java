...
import ti4.buttons.handlers.strategycard.StrategyCardMiscButtonHandler;
...
public class PlayStrategyCardService {
    ...
    public static void playSC(
        ...
        if (scModel.usesAutomationForSCID("pok3politics") || scModel.usesAutomationForSCID("cryypter_3")) {
            ...
            if (player.isNpc()) {
                StrategyCardMiscButtonHandler.sc3AssignSpeaker(null, player, player.getFaction(), game);
            }
        }
        ...
        if (!game.isHomebrewSCMode()
            ...
            graceButtons.add(Buttons.green(
                    player.getFinsFactionCheckerPrefix() + "resolveGrace_" + scToPlay, "Resolve Grace Ability"));
