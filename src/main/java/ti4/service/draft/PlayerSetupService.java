...
public class PlayerSetupService {
    ...
    public static void setupPlayer(
        ...
        String color = setupState.getColor();
        String faction = setupState.getFaction();
        String positionHS = setupState.getHomeSystemPosition();
        boolean isSpeaker = setupState.isSpeaker();
