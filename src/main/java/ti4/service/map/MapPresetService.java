...
public class MapPresetService {
    ...
    public static final List<String> templates =
            List.of("Solo (1 slice)", "Minimal Solo (1 slice)", "TspMap (6 slices)", "Magi's Madness (0 slices)");
    ...
    public void build(SlashCommandInteractionEvent event, Game game, String template) {
        ...
        String[] s1 =
                slice1 != null ? slice1.replace(",", " ").replace("  ", " ").split(" ") : null;
        String[] s2 =
                slice2 != null ? slice2.replace(",", " ").replace("  ", " ").split(" ") : null;
        String[] s3 =
                slice3 != null ? slice3.replace(",", " ").replace("  ", " ").split(" ") : null;
        String[] s4 =
                slice4 != null ? slice4.replace(",", " ").replace("  ", " ").split(" ") : null;
        String[] s5 =
                slice5 != null ? slice5.replace(",", " ").replace("  ", " ").split(" ") : null;
        String[] s6 =
                slice6 != null ? slice6.replace(",", " ").replace("  ", " ").split(" ") : null;
        ...
        switch (template) {
            case "Solo (1 slice)" -> {
                ...
                List<String> tiles = List.of(
                        "85a3", "85a4", "85a5", s1[4], "85a1", "85a2", // ring 1
                        "85a3", "84a0", "85a4", "84a1", "85a5", "87a5", s1[1], s1[3], "85a1", "84a4", "85a2",
                        "84a5", // ring 2
                        "85a3", "84a0", "84a0", "85a4", "84a1", "84a1", "85a5", "84a2", s1[2], home, s1[0], "84a3",
                        "85a1", "84a4", "84a4", "85a2", "84a5", "84a5"); // ring 3
            ...
            case "TspMap (6 slices)" -> {
                ...
                List<String> tiles = List.of(
                        s1[4], ph, ph, s4[4], ph, ph, // ring 1
                        home, s1[2], s2[4], ph, s3[4], s4[1], home, s4[0], s5[4], ph, s6[4], s1[1], // ring 2
                        ph, s1[3], s2[1], home, s2[2], s3[2], home, s3[1], ph, s4[3], s4[2], s5[2], home, s5[1], s6[1],
                        home, s6[2], s1[0], // ring 3
                        ph, ph, ph, s2[0], s2[3], ph, ph, ph, s3[3], s3[0], ph, ph, ph, ph, ph, s5[0], ph, s5[3], ph,
                        s6[3], ph, s6[0], ph, ph); // ring 4
                // 29,27,41,62,43
            ...
            case "Magi's Madness (0 slices)" -> {
                String mapString =
                        "{85A2} 70 84A5 0g 83A2 69 0g 62 42 90B1 36 27 34 65 68 46 76 74 75 0g 88B2 26 44 37 66 25 43 48 19 18 78"
