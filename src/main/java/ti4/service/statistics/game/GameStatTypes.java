...
public enum GameStatTypes {
    ...
    EXPEDITION_WIN_RATES(
            "Thunder's Edge expedition win rates",
            "Shows win rates for expedition choices, expedition count, last expedition completer, and Thunder's Edge control"),
