...
public class StartCombatService {
        ...
        for (Player player : combatPlayers) {
            ...
            if (type.equalsIgnoreCase("space")
                ...
                MessageHelper.sendMessageToChannel(
                        player.getCardsInfoThread(),
                        msg
                                + ", this is a reminder that if you win the combat, and your flagship survives, you could score _Unveil Flagship_.");
            }
            if (type.equalsIgnoreCase("space")
            ...
            if (player.hasAbility("war_stories")) {
                msg = msg
                        + ", this is a reminder that if you win the combat, and you have not already done so this action, you may use **War Stories** to explore any planet you control.";
            ...
            if (player.getSecretsUnscored().containsKey("dyp") && capitalShips >= 3) {
                MessageHelper.sendMessageToChannel(
                        player.getCardsInfoThread(),
                        msg
                                + ", this is a reminder that if you win the combat (or otherwise keep ships in the active system), and you lose "
            ...
            if ((player.hasAbility("edict") || player.hasAbility("imperia"))
                ...
                buttons.add(Buttons.gray(
                        ...
                        "Add Opponent Command Token to Fleet Pool",
            ...
            if (player.hasAbility("technological_singularity")) {
                Button steal = Buttons.gray(
                        ...
                        FactionEmojis.Nekro);
                String message = msg
                        + " this is a reminder that when you first kill an opponent's unit this combat, you may use the button to copy a technology.";
            ...
            if (player.hasUnit("ghemina_mech")
                ...
                Button explore = Buttons.gray(
                        player.finChecker() + "gheminaMechStart_" + otherPlayer.getFaction(),
                        "Mech Explores",
            ...
            if (type.equalsIgnoreCase("space") && game.playerHasLeaderUnlockedOrAlliance(player, "mentakcommander")) {
                ...
                MessageHelper.sendMessageToChannelWithButtons(
                        player.getCardsInfoThread(),
                        msg + " this is a reminder that if you win the combat, "
    ...
    private static void sendGeneralCombatButtonsToThread(
            ...
            GenericInteractionCreateEvent event) {
        List<Button> buttons =
                getGeneralCombatButtons(game, tile.getPosition(), player1, player2, spaceOrGround, event);
    ...
    public static List<Button> getGeneralCombatButtons(
            Game game, String pos, Player p1, Player p2, String groundOrSpace, GenericInteractionCreateEvent event) {
        ...
        if (!game.isFowMode() && ghemina != null && ghemina.hasUnexhaustedLeader("gheminaagent")) {
            ...
            buttons.add(Buttons.gray(
                    finChecker + "exhaustAgent_gheminaagent", "Use Ghemina Agents", FactionEmojis.ghemina));
        }
        ...
        if (!game.isFowMode() && khal != null && khal.hasUnexhaustedLeader("kjalengardagent")) {
            ...
            buttons.add(Buttons.gray(
                    finChecker + "exhaustAgent_kjalengardagent", "Use Kjalengard Agent", FactionEmojis.kjalengard));
        }
        ...
        if ((!game.isFowMode() || letnev == p1)
                && letnev != null
                && letnev.hasUnexhaustedLeader("letnevagent")
                && "space".equalsIgnoreCase(groundOrSpace)) {
            buttons.add(Buttons.gray(
                    letnev.finChecker() + "getAgentSelection_letnevagent", "Use Letnev Agent", FactionEmojis.Letnev));
        }
        // Exo 2s
        ...
        if ((!game.isFowMode() || nomad == p1) && nomad != null && nomad.hasUnexhaustedLeader("nomadagentthundarian")) {
            ...
            buttons.add(Buttons.gray(
                    finChecker + "exhaustAgent_nomadagentthundarian", "Use The Thundarian", FactionEmojis.Nomad));
        }
        ...
        if (p1.hasLeaderUnlocked("kortalihero")) {
            String finChecker = "FFCC_" + p1.getFaction() + "_";
            buttons.add(Buttons.gray(
                    finChecker + "purgeKortaliHero_" + p2.getFaction(), "Purge Kortali Hero", FactionEmojis.dihmohn));
        }
            ...
            if (unitH instanceof Planet) {
                ...
                for (Player p : List.of(p1, p2)) {
                    ...
                    if (p.hasUnit("letnev_mech")
                            && isGroundCombat
                            && unitH.getUnitCount(Units.UnitType.Infantry, p1.getColor()) > 0
            ...
            if ("space".equalsIgnoreCase(nameOfHolder) && isSpaceCombat) {
                ...
                if (!isSpaceCombat && !"space".equalsIgnoreCase(nameOfHolder)) {
                    ...
                    if (CombatRollService.checkIfUnitsOfType(
                            nonActive, game, event, tile, unitH.getName(), CombatRollType.SpaceCannonDefence)) {
                        buttons.add(Buttons.gray(
