    ...
    private static void sendStartOfCombatSecretMessages(Game game, Player p1, Player p2, Tile tile, String type, String unitHolderName) {
        ...
        for (Player player : combatPlayers) {
            ...
            if (player.hasAbility("war_stories")) {
                msg = msg + ", this is a reminder that if you win the combat, and you have not already done so this action, you can use war stories to explore any planet you control.";
                buttons = new ArrayList<>();
                buttons.add(Buttons.green("warStoriesPlanetExplore", "Explore A Planet You Control"));
                if(tile.getPlanetUnitHolders().isEmpty()){
                    msg += " Instead of exploring a planet you control, you can explore the frontier deck in this tile, since the system contains no planets";
