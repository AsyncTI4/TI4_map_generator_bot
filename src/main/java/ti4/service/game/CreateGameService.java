...
public class CreateGameService {
    ...
    public String autoGenerateGameName() {
        ...
        List<String> words = new ArrayList<>(Arrays.asList(
                ...
                "Enzyme",
                "Causality"));
        // extra words: "Waypoint", "Faraday", "Perihelion", "Penumbra", "Barycentric", "Helical", "Stoichiometry",
        // "Mechatronic", "Cognitive", "Newtonian"
        // avoid words that are similar to names of TI4 components (or parts thereof) e.g. "Quantum"
        // also avoid words that are similar to existing words or the list e.g. "Cyberspace" -> Nullspace", "Subspace",
        // "Hyperspace"
        // spotless:on
