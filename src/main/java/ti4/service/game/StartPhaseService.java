...
public class StartPhaseService {
    ...
    public static String getQueueSCMessage(Game game, Player player) {
        ...
        String msg = player.getRepresentation() + " you are #" + number + " pick in this Strategy Phase and so can queue "
    ...
    public static void startActionPhase(GenericInteractionCreateEvent event, Game game, boolean incrementTgs) {
        ...
        if (isFowPrivateGame) {
            ...
            if (nextNextPlayer == nextPlayer) {
                ...
                String ping = UserSettingsManager.get(nextNextPlayer.getUserID()).isPingOnNextTurn()
