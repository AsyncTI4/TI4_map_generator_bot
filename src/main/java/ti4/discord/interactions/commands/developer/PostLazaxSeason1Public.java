...
class PostLazaxSeason1Public extends Subcommand {

    PostLazaxSeason1Public() {
        super("post_lazax_season_1_public", "Post only the Lazax Season 1 public opening message");
    }
