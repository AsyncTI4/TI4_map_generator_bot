...
class TargetPlanetPing extends GameStateSubcommand {

    public TargetPlanetPing() {
        super(Constants.TARGET_PLANET_PING, "Ping a planet as the target of your action card", false, true);
        addOptions(new OptionData(OptionType.STRING, Constants.PLANET, "Planet you are targeting")
                .setRequired(true)
    ...
    public void execute(SlashCommandInteractionEvent event) {
        ...
        String planetId =
                AliasHandler.resolvePlanet(event.getOption(Constants.PLANET).getAsString());
        ...
        if (!ActionCardPingButtonHandler.pingPlanetTarget(game, getPlayer(), planetId, isPublic, cardTitle)) {
