package ti4.discord.interactions.buttons.handlers.faction.base.xxcha;
...
class XxchaAgentButtonHandler {
    ...
    public static void resolveXxchaAgentInfantryRemoval(
        ...
        RemoveUnitService.removeUnits(
                event, game.getTileContainingPlanet(planet), game, p2.getColor(), "1 infantry " + planet);
        ButtonHelper.resolveInfantryRemoval(p2, 1, game.getTileContainingPlanet(planet));
