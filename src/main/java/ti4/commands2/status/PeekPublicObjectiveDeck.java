...
class PeekPublicObjectiveDeck extends GameStateSubcommand {
  ...
  public PeekPublicObjectiveDeck() {
    ...
    addOptions(new OptionData(OptionType.INTEGER, STAGE_COMMAND_NAME, "1 or 2")
        .setRequired(true));
  ...
  public void execute(SlashCommandInteractionEvent event) {
    ...
    MessageHelper.sendMessageToChannelWithEmbeds(player.getCardsInfoThread(), null,
        publicObjectiveEmbedMessages);
  }
